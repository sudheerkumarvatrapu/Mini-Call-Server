...
- Version: `1.6.2`
- Helm chart package: `helm/playsbc-1.6.2.tgz`
- Project license: MIT
- Chart version: `1.6.2`
...
shasum -a 256 release/helm/playsbc-1.6.2.tgz > release/helm/playsbc-1.6.2.tgz.sha256
```
...
PYTHONPYCACHEPREFIX=/private/tmp/playsbc-pycache python3 tools/run_k8s_regression_job.py \
  --all-profiles \
  --runner-image ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.6.2 \
  --sipp-image ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.6.2 \
  --playsbc-image ghcr.io/sudheerkumarvatrapu/playsbc:1.6.2 \
  --set-playsbc-image \
