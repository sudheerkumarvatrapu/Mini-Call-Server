...
- Version: `2.4.2`
- Helm chart package: `helm/playsbc-2.4.2.tgz`
- Project license: MIT
- Chart version: `2.4.2`
...
shasum -a 256 release/helm/playsbc-2.4.2.tgz > release/helm/playsbc-2.4.2.tgz.sha256
```
...
- `ghcr.io/sudheerkumarvatrapu/playsbc:2.4.2`
- `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.4.2`
- `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.4.2`
- `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.4.2`

Deploy the release chart:

```bash
helm upgrade --install playsbc helm/playsbc-2.4.2.tgz \
  --namespace playsbc \
  --create-namespace \
  -f configs/kubernetes/active-active-values.yaml \
  --set image.repository=ghcr.io/sudheerkumarvatrapu/playsbc \
  --set-string image.tag=2.4.2 \
  --set rtpengine.enabled=true \
  --set rtpengine.image.repository=ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine \
  --set-string rtpengine.image.tag=2.4.2 \
...
PYTHONPYCACHEPREFIX=/private/tmp/playsbc-pycache python3 tools/run_k8s_regression_job.py \
  --all-profiles \
  --runner-image ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.4.2 \
  --sipp-image ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.4.2 \
  --playsbc-image ghcr.io/sudheerkumarvatrapu/playsbc:2.4.2 \
  --set-playsbc-image \
