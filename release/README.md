...
| --- | --- |
| Version | `2.5.2` |
| Chart | `helm/playsbc-2.5.2.tgz` |
| Checksum | `helm/playsbc-2.5.2.tgz.sha256` |
| Notes | `RELEASE_NOTES_2.5.2.md` |
| License | MIT |

Published images:

```text
ghcr.io/sudheerkumarvatrapu/playsbc:2.5.2
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.5.2
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.5.2
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.5.2
```
...
shasum -a 256 release/helm/playsbc-2.5.2.tgz \
  > release/helm/playsbc-2.5.2.tgz.sha256
```
