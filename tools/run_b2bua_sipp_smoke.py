...
B2BUA_PROFILES = {
    ...
    "register-auth-tcp": {
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["transport=tcp method=REGISTER", "status=200"],
        },
    },
    "register-auth-tls": {
        "caller": "auth-tls-a",
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["transport=tls method=REGISTER", "status=200"],
        },
    },
    "dtmf-rfc4733": {
        "callee": "dtmf-b",
    ...
    "ai-rasa-long-response-streaming": {
        "caller": "ai-stream-core-a",
        "callee": "ai-stream-bot",
        "register_callee": False,
        "start_uas": False,
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        "media_pcap": "pcap/ai_rasa_speech_g711u.pcap",
        "media_driver": "sipp-pcap",
        "hold_ms": 12000,
        "rasa_deployment": "real",
        "route_policies": [
            {
                "name": "ai-rasa-streaming-gateway",
                "match": "ai-stream-bot",
                "target": "ai-gateway:rasa-support",
                "priority": 5,
            }
        ...
        "ai_voice_gateway": {
            ...
            "provider": "rasa",
            "bot_name": "rasa-support",
            "rasa_webhook_url": "http://172.28.0.61:5005/webhooks/rest/webhook",
            "rasa_timeout": 5.0,
            "input_mode": "speech",
            "initial_message": "please give me a detailed support update",
            "speech_transcript": "Please give me a detailed support update",
            "speech_input_pcap": "sipp/scenarios/pcap/ai_rasa_speech_g711u.pcap",
            "speech_input_codec": "PCMU",
            "fallback_text": "Rasa streaming bot is unavailable",
            "stt_provider": "lab-scripted",
            "tts_provider": "piper",
        ...
        "expected_log_markers": {
            "log.ai": [
                ...
                "response_mode=streaming",
                "tts_chunk_count=3",
                "Streaming support update is ready",
                "AI TTS STREAM START",
                "AI TTS STREAM CHUNK",
                "chunk_count=3",
                "renderer=piper",
                "audio_generated=true",
                "rtp_prompt_generated=true",
            ],
            "log.media": ["AI RTPENGINE MEDIA", "AI TTS RTP PROMPT", "B2BUA RTPENGINE QUERY"],
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "Piper TTS"],
        },
    },
    "ai-rasa-real-lab": {
        "caller": "ai-core-a",
        ...
        "expected_log_markers": {
            "log.ai": [
                "AI VOICE CALL START",
                "rasa_webhook=http://172.28.0.61:5005/webhooks/rest/webhook",
                "RASA REST REQUEST",
                "RASA REST RESPONSE",
                "fallback_used=false",
            ...
            "log.media": ["AI RTPENGINE MEDIA", "AI RTPENGINE ANSWER", "B2BUA RTPENGINE QUERY"],
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "Rasa Bot"],
        },
    },
    "ai-rasa-rtpengine-speech": {
        "caller": "ai-speech-core-a",
        "callee": "ai-speech-bot",
        "register_callee": False,
        "start_uas": False,
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        ...
        "ai_voice_gateway": {
            ...
            "speech_input_pcap": "sipp/scenarios/pcap/ai_rasa_speech_g711u.pcap",
            "speech_input_codec": "PCMU",
            "fallback_text": "Real Rasa speech lab bot is unavailable",
            "stt_provider": "vosk",
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "STT Adapter", "Rasa Bot", "TTS Adapter"],
        },
    },
    "ai-rasa-rtpengine-speech-whisper": {
        "caller": "ai-whisper-core-a",
        "callee": "ai-whisper-bot",
        "register_callee": False,
        "start_uas": False,
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        ...
        "route_policies": [
            {
                "name": "ai-rasa-whisper-gateway",
                "match": "ai-whisper-bot",
                "target": "ai-gateway:rasa-support",
                "priority": 5,
            }
        ],
        "ai_voice_gateway": {
            ...
            "speech_input_pcap": "sipp/scenarios/pcap/ai_rasa_speech_g711u.pcap",
            "speech_input_codec": "PCMU",
            "fallback_text": "Real Rasa Whisper speech lab bot is unavailable",
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "Whisper STT", "Rasa Bot", "Piper TTS"],
        },
    },
    "ai-rasa-contact-center-sales": {
        "caller": "sales-caller-a",
        "callee": "sales-agent-b",
        "register_callee": False,
        "start_uas": False,
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        "media_pcap": "pcap/ai_contact_center_sales_g711u.pcap",
        "media_driver": "sipp-pcap",
        "hold_ms": 12000,
        "rasa_deployment": "real",
        "route_policies": [
            {
                "name": "ai-contact-center-sales",
                "match": "sales-agent-b",
                "target": "ai-gateway:sales-support",
                "priority": 5,
            }
        ],
        "ai_voice_gateway": {
            "enabled": True,
            "provider": "rasa",
            "bot_name": "sales-support",
            "agent_label": "SIPp B Bot Agent",
            "contact_center_queue": "sales",
            "contact_center_skill": "sales-support",
            "rasa_webhook_url": "http://172.28.0.61:5005/webhooks/rest/webhook",
            "rasa_timeout": 5.0,
            "input_mode": "speech",
            "initial_message": "connect me to sales",
            "speech_transcript": "Connect me to sales",
            "speech_input_pcap": "sipp/scenarios/pcap/ai_contact_center_sales_g711u.pcap",
            "speech_input_codec": "PCMU",
            "fallback_text": "Sales support bot agent is unavailable",
            "stt_provider": "vosk",
            "stt_command": "python3 tools/vosk_stt_wrapper.py --audio {audio_path}",
            "tts_provider": "piper",
            "tts_command": "python3 tools/piper_tts_wrapper.py --text \"{text}\" --output {audio_path}",
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "SIPp B Bot Agent", "Vosk STT", "Piper TTS"],
        },
    },
    "ai-rasa-contact-center-sales-coqui": {
        "caller": "sales-coqui-caller-a",
        "callee": "sales-coqui-agent-b",
        "register_callee": False,
        "start_uas": False,
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        ...
        "route_policies": [
            {
                "name": "ai-contact-center-sales-coqui",
                "match": "sales-coqui-agent-b",
                "target": "ai-gateway:sales-support",
                "priority": 5,
            }
        ],
        "ai_voice_gateway": {
            ...
            "speech_input_pcap": "sipp/scenarios/pcap/ai_contact_center_sales_g711u.pcap",
            "speech_input_codec": "PCMU",
            "fallback_text": "Sales support Coqui bot agent is unavailable",
            "stt_provider": "vosk",
            "stt_command": "python3 tools/vosk_stt_wrapper.py --audio {audio_path}",
            "tts_provider": "coqui",
        ...
        "expected_log_markers": {
            ...
            "log.sip": ["AI VOICE CALL LADDER", "RTPengine", "SIPp B Bot Agent", "Vosk STT", "Coqui TTS"],
        },
    },
    "invalid-bye": {
    ...
    "ha-playsbc-precall-failover": {
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-precall-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "precall",
            "target": "playsbc",
        ...
        "expected_log_markers": {
            "log.platform": ["HA NODE STARTED", "K8S HA ACTION"],
            "log.media": ["RTPENGINE OFFER", "RTPENGINE ANSWER"],
        },
    },
    "ha-playsbc-midcall-failover": {
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-midcall-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "midcall",
            "target": "playsbc",
        ...
        "expected_log_markers": {
            "log.platform": ["HA DIALOG RESTORED", "HA B2BUA CALL RESTORED", "K8S HA ACTION"],
            "log.media": ["RTPENGINE OFFER", "RTPENGINE ANSWER"],
        },
    },
    "ha-playsbc-postcall-failover": {
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-postcall-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "postcall",
            "target": "playsbc",
    ...
    "ha-rtpengine-precall-failover": {
        "caller": "ha-rtpe-pre-a",
        "callee": "ha-rtpe-pre-b",
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        "media_driver": "sipp-pcap",
        "hold_ms": 10000,
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-rtpe-pre-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "precall",
            "target": "rtpengine",
        ...
        "expected_log_markers": {
            "log.platform": ["K8S HA ACTION"],
            "log.media": ["RTPENGINE OFFER", "RTPENGINE ANSWER"],
        },
    },
    "ha-rtpengine-midcall-recovery": {
        "caller": "ha-rtpe-mid-a",
        "callee": "ha-rtpe-mid-b",
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        "media_driver": "sipp-pcap",
        "hold_ms": 20000,
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-rtpe-mid-state.sqlite3",
            "failover": {"rtpengine_session_migration": "best-effort-recovery"},
        },
        "k8s_ha_action": {
            "phase": "midcall",
            "target": "rtpengine",
    ...
    "ha-node-drain-active-calls": {
        "caller": "ha-drain-active-a",
        "callee": "ha-drain-active-b",
        "media_backend": "rtpengine",
        "media_codec": "PCMU",
        "media_driver": "sipp-pcap",
        "hold_ms": 15000,
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-active-drain-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "midcall",
            "target": "playsbc",
        ...
        "k8s_verify_drain_reject": True,
        "expected_log_markers": {
            "log.platform": ["HA NODE RUNTIME DRAIN", "K8S HA ACTION"],
            "log.call": ["CALL END", "HA NODE DRAINING REJECT"],
        },
    },
    "ha-active-active-load-distribution": {
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-load-state.sqlite3",
        },
        "expected_log_markers": {
    ...
    "ha-shared-registrar-dialog-restore": {
        ...
        "ha": {
            ...
            "cluster_id": "playsbc-aa-lab",
            "node_id": "playsbc-a",
            "shared_state_path": "/tmp/playsbc-{run_id}-restore-state.sqlite3",
        },
        "k8s_ha_action": {
            "phase": "midcall",
            "target": "playsbc",
        ...
        "expected_log_markers": {
            "log.platform": ["HA REGISTRATION SYNC", "HA DIALOG RESTORED", "HA B2BUA CALL RESTORED"],
            "log.media": ["RTPENGINE OFFER", "RTPENGINE ANSWER"],
        },
    },
...
PROFILE_DESCRIPTIONS = {
    ...
    "register-auth-tcp": "Complete digest REGISTER over SIP/TCP without placing a call, preserving the UDP/RTP real-device baseline.",
    "register-auth-tls": "Complete digest REGISTER over SIP/TLS 1.2+ without placing a call and retain certificate/transport evidence.",
    "dtmf-rfc4733": "Send and relay an RFC 4733 telephone-event during an established B2BUA media call.",
    "ai-rasa-lab": "Mock Rasa REST lab: PlaySBC terminates the AI call, uses internal RTP input, and verifies one deterministic mock Rasa response.",
    "ai-rasa-rtpengine": "Mock Rasa with RTPengine lab: RTP/RTCP is anchored by RTPengine and the mock Rasa service returns multiple replies plus a transfer action.",
    "ai-rasa-real-lab": "Real Rasa pod lab: Kubernetes starts and trains an actual Rasa REST bot, then PlaySBC reaches it through RTPengine-backed AI call control.",
    "ai-rasa-rtpengine-speech": "Real Rasa speech lab: SIPp plays G.711 speech, PlaySBC decodes the RTP PCAP to WAV for STT, sends the transcript to Rasa, generates TTS WAV/RTP evidence, and keeps media anchored by RTPengine.",
    "ai-rasa-rtpengine-speech-whisper": "Whisper STT variant: SIPp speech is decoded to WAV, the Whisper adapter boundary transcribes it, real Rasa responds, Piper generates RTP prompt evidence, and RTPengine anchors media.",
    "ai-rasa-long-response-streaming": "Long-response streaming lab: RTPengine anchors a speech call while mock Rasa returns multiple replies and PlaySBC emits chunked Piper TTS WAV/RTP prompt evidence.",
    "ai-rasa-contact-center-sales": "Contact-center sales bot lab: SIPp A calls a virtual SIPp B bot agent, PlaySBC answers the B side, RTPengine anchors media, Vosk transcribes caller speech, real Rasa runs the sales workflow, and Piper returns the bot-agent voice prompt.",
    "ai-rasa-contact-center-sales-coqui": "Coqui TTS contact-center variant: SIPp A reaches a virtual SIPp B sales bot, Vosk transcribes, real Rasa runs the sales workflow, and Coqui generates the bot-agent RTP prompt evidence.",
    ...
    "ha-playsbc-postcall-failover": "Delete one PlaySBC pod after normal call release and verify the active-active StatefulSet recovers cleanly.",
    "ha-rtpengine-precall-failover": "Delete one RTPengine pod before call setup and verify paired RTPengine recovery still anchors the call.",
    "ha-rtpengine-midcall-recovery": "Delete one RTPengine pod during an active call and verify best-effort media recovery/cleanup evidence.",
    "ha-node-drain-active-calls": "Runtime-drain PlaySBC nodes during an active call, let the existing call finish, then verify a new INVITE is rejected.",
    "ha-active-active-load-distribution": "Run a small active-active RTPengine-backed load profile and capture per-node/pair evidence.",
    "ha-shared-registrar-dialog-restore": "Register both realms, delete one PlaySBC pod during the call, and verify shared registrar/dialog/B-leg restore evidence.",
