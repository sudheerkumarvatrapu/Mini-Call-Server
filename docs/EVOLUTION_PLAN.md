...
- `v2.0.0`: real-device AKS lab baseline. Include the v1.6.5/v1.6.6 cleanup, reject missing registered routes instead of fallback echo, add configurable B2BUA outbound INVITE timeout, and add optional RTPengine G.711-only codec clamp for the first OBi1022/Zoiper media baseline.
