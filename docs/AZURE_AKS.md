...
- PlaySBC v2.1.1 emits SIP route, response, ACK/BYE forwarding, timeout seconds, codec clamp, NAT-learning, and RTPengine evidence to `kubectl logs` when persistent file logs are disabled in AKS.
