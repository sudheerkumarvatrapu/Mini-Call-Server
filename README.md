...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v2.3.1-111827?style=flat-square">
...
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v2.3.1>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:2.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.3.1`
...
```text
https://github.com/sudheerkumarvatrapu/PlaySBC/releases/download/v2.3.1/playsbc-2.3.1.tgz
```

Published images:

```text
ghcr.io/sudheerkumarvatrapu/playsbc:2.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.3.1
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v2.3.1`.
