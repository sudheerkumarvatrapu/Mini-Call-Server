...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v2.2.1-111827?style=flat-square">
...
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v2.2.1>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:2.2.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.2.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.2.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.2.1`
...
```text
https://github.com/sudheerkumarvatrapu/PlaySBC/releases/download/v2.2.1/playsbc-2.2.1.tgz
```
...
1. Upgrade PlaySBC and RTPengine to `v2.2.1`.
