...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v1.5.5-111827?style=flat-square">
...
[Evolution plan](docs/EVOLUTION_PLAN.md) | [RTPengine runbook](docs/RTPENGINE_LOCAL.md) | [AI Voice Gateway](docs/AI_VOICE_GATEWAY.md) | [Observability](docs/OBSERVABILITY.md) | [Kubernetes lab](docs/KUBERNETES_LOCAL.md) | [Kubernetes Helm runbook](docs/KUBERNETES_HELM_RUNBOOK.md) | [Azure AKS](docs/AZURE_AKS.md)

## Status

- Version: `1.5.5`
- Local baseline: `v1.4.2` remains the frozen kind/minikube/local regression reference, and the v1.5.5 chart must continue to run the same kind regression path with locally built images.
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v1.5.5>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:1.5.5`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.5.5`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.5.5`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.5.5`
...
This remains the required v1.5.5 kind safety gate. It builds PlaySBC, RTPengine, SIPp, and the regression runner from the current source tree and loads those images into kind, so it does not depend on published `v1.5.5` GHCR images.
...
```text
https://github.com/sudheerkumarvatrapu/PlaySBC/releases/download/v1.5.5/playsbc-1.5.5.tgz
```

Published images:

```text
ghcr.io/sudheerkumarvatrapu/playsbc:1.5.5
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.5.5
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.5.5
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.5.5
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v1.5.5`.
