...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v2.3.2-111827?style=flat-square">
...
- Version: `2.3.2`
- Local baseline: `v1.4.2` remains the frozen kind/minikube/local regression reference, and v2.x charts must continue to run the same kind regression path with locally built images.
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v2.3.2>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:2.3.2`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.3.2`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.3.2`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.3.2`
...
```text
https://github.com/sudheerkumarvatrapu/PlaySBC/releases/download/v2.3.2/playsbc-2.3.2.tgz
```

Published images:

```text
ghcr.io/sudheerkumarvatrapu/playsbc:2.3.2
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:2.3.2
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:2.3.2
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:2.3.2
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v2.3.2`.
